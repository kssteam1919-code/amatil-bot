...
# Товары в наличии для случайного подбора
AVAILABLE_PRODUCTS = [
...
async def start(message: types.Message):
    ...
    await message.answer(
        ...
        "Мы предлагаем исключительно оригинальные устройства и авторские жидкости, "
        "сочетая безупречное качество с оперативным сервисом.\n\n"
...
async def handle_all(message: types.Message):
    ...
    if message.text == "💬 Отзывы":
        ...
        await message.answer(
            ...
            "📦 Доставка по РФ — 2–4 рабочих дня (Почта России, СДЭК, Boxberry).\n"
            "💳 Оплата — банковский перевод или наличные при личной встрече.\n"
        ...
        await message.answer(
            "📦 Условия доставки\n\n"
            "• Службы: Почта России, СДЭК, Boxberry.\n"
            "• Отправка в день оформления заказа (до 18:00).\n"
            "• Трек-номер предоставляется сразу после передачи в службу.\n"
        ...
        await message.answer(
            ...
            "• Наличный расчёт при личной встрече (Москва).\n"
