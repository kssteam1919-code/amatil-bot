...
async def handle_all(message: types.Message):
    ...
    if message.web_app_data:
        ...
        await message.answer("✅ Заказ принят! Ожидайте подтверждения менеджера.\n📲 @Fe3riko")
        return
    ...
    if message.text == "💬 Отзывы":
        ...
        facts = ["Первый прототип электронной сигареты был запатентован в 1965 году.", "Качественная жидкость не содержит диацетила и других вредных примесей.", "Мятные вкусы остаются самыми популярными в мире благодаря своей универсальности."]
        ...
        await message.answer("📋 История заказов находится в разработке.")
